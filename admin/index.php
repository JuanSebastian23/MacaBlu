...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
    <div class="app-wrapper">
        ...
        //Menu lateral
        include_once __DIR__ . '/view/menu-lateral.php';
        ?>
        <main class="app-main">
            <div class="app-content-header">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <?php include_once __DIR__ . '/view/dashboard.php'; ?>
                    </div>
                </div>
            </div>
            <!-- Sección de gestión de usuarios -->
            <div id="gestion-usuarios" style="display: none;">
                <?php include_once __DIR__ . '/view/gestion-usuarios.php'; ?>
            </div>
            <!-- Sección de gestión de productos -->
            <div id="gestion-productos" style="display: none;">
                <?php include_once __DIR__ . '/view/gestion-productos.php'; ?>
            </div>
        </main>
        <!-- Pie de página -->
